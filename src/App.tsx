...
function App() {
  ...
  const [adminInitialTab, setAdminInitialTab] = useState<"product" | "client">(
    "product"
  );
  ...
  const handleRedirectToClientCreation = () => {
    setAdminInitialTab("client");
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-6 relative min-h-screen bg-gray-50/50 font-sans text-gray-800">
      ...
      <CartDrawer
        ...
        onGoToAdmin={handleRedirectToClientCreation}
      />
