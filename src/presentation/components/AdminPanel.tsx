 ...
 * Centraliza la gestión (CRUD) de Productos del inventario y el registro de Clientes.
 */
export const AdminPanel = ({
  ...
  onClientAdded: () => void;
  initialTab?: "product" | "client";
}) => {
  const { inventoryService, clientService } = useServices();
  const { products } = useInventory();

  const [tab, setTab] = useState<"product" | "client">(initialTab);
  ...
  const styles = {
    ...
    input:
      "w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-50 outline-none transition-all duration-200 bg-white placeholder-gray-400 text-sm",
    label:
  ...
  /**
   * Prepara el formulario de productos para la edición.
   * Rellena los inputs imperativamente para evitar re-renderizados innecesarios.
   */
  ...
  /**
   * Procesa el envío del formulario de productos (Creación o Actualización).
   */
        ...
        {tab === "product" ? (
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
            ...
            <div className="xl:col-span-1">
              <div
                className={`p-6 rounded-2xl border h-fit sticky top-24 transition-colors duration-300 ${
                  editingId
              ...
              >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <h3
                      className={`font-bold text-lg ${
                        editingId ? "text-amber-800" : "text-gray-800"
                      }`}
                    >
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className={styles.label}>
                        {editingId ? "Stock (Editar)" : "Stock Inicial"}
                      </label>
                      <div className={styles.inputWrapper}>
                  ...
                  <button
                    type="submit"
                    className={`mt-2 w-full py-3.5 text-white font-bold rounded-xl shadow-lg transition-all active:scale-[0.98] flex items-center justify-center gap-2 ${
                      editingId
            ...
            <div className="xl:col-span-1">
              <div className="bg-indigo-50/30 p-6 rounded-2xl border border-indigo-100 h-fit sticky top-24">
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="mt-2 w-full py-3.5 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl shadow-lg shadow-indigo-200 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
                  >
                    <Plus size={20} />
                    Registrar Cliente
                  </button>
